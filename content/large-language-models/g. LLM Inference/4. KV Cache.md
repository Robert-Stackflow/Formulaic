...
- 下图展示了在注意力计算过程中如何从 token embeddings 中计算得到 KV 向量
  ...
  <img src="/img/kv-calculate.png" alt="KV Calculate" style="zoom: 80%;" />
...
- 大语言模型一次生成一个词（或者 token），假设大语言模型生成了“fast”这个词，那么下一轮的 Prompt 就变成了“Time flies fast”
  ...
  <img src="/img/kv-calcuate-duplicate.png" alt="KV Calculate Duplicate" style="zoom:80%;" />
...
<img src="/img/kv cache comparison.png" alt="KV Cache 有无对比" style="zoom:80%;" />
