/**
 * Feature definitions and metadata for Formulaic
...
export const FEATURES = {
  "data-ownership": {
    ...
    description:
      "Take full control of your notes and data with Formulaic' privacy-first architecture that ensures your information never leaves your control.",
    hero: {
      title: "Your Data, Your Rules",
      subtitle:
        "Complete ownership and control over every note, file, and piece of information in your Formulaic instance.",
    },
    benefits: [
  ...
  "customizable-ui": {
    ...
    description:
      "Customize your Formulaic instance with personalized branding, themes, and UI elements to match your style.",
    hero: {
      title: "Make It Yours",
      subtitle:
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Differentiate between multiple Formulaic instances with custom branding.",
      },
    ],
    techDetails: [
  ...
  "open-source": {
    ...
    hero: {
      ...
      subtitle:
        "MIT license ensures complete freedom to use, modify, and distribute Formulaic for any purpose.",
    },
    benefits: [
  ...
  community: {
    ...
    hero: {
      ...
      subtitle:
        "Active community of developers and users collaborating to make Formulaic better for everyone.",
    },
    benefits: [
    ...
    useCases: [
      ...
      },
      {
        ...
        description:
          "Learn from and share solutions with other Formulaic users.",
      },
    ],
    techDetails: [
  ...
  "self-hosted": {
    ...
    description:
      "Deploy Formulaic on your own infrastructure with complete control over access, security, and performance.",
    hero: {
    ...
    useCases: [
      {
        ...
        description:
          "Run Formulaic on your home server or NAS for personal and family use with complete privacy.",
      },
      {
